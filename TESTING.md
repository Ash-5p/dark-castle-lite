...
| | During combat, entering "i" while holding a consumable item is expected to display the item description & prompt the player to use the item. Entering "y" is expected to apply the item's effect and remove it from the player's item slot | Tested the feature by entering "y" when prompted to use an item in combat | The feature behaved as expected, and applied the item's effect and removed it from the player's item slot  | Test concluded and passed | ![screenshot](documentation/features/feature-combat.png) | ![screenshot](documentation/features/feature-combat-noitem.png) | ![screenshot](documentation/features/feature-combat-item.png) |
