...
def intro_chapter(player_character, player_name):
    ...
    center_print(
        "You awaken and find yourself in a empty, dark room with stone walls.You look up \n" 
...
def chapter_1a(player_character, player_name, homescreen):
    ...
    clear_terminal_in_game(player_character, player_name)
    center_print(
        "You push the door, which opens with a loud creak. You emerge in a long corridor \n"
    ...
    center_print(
        "Not knowing what you will face, you toy with the idea of taking the chainmail for\n"
        "yourself\n"
    )
    ...
    while True:
        ...
        if choice == "y":
            if random.randrange(1,11) >= 5:
                ...
                center_print(
                    "As you attempt to remove the guards armor he begins to stir, suddenly springing to his \n" 
...
def chapter_1b(player_character, player_name, homescreen):
    ...
    clear_terminal_in_game(player_character, player_name)
    center_print(
        "You wait in your cell, pondering how you woke up here. Suddenly, you hear a metal \n"
        "clattering sound, followed by a loud creak and bang as your cell door slams open \n"
    )
        
    center_print(
        "An enraged, dazed looking guard, clad in chainmail stands blocking the doorway. You \n"
...
def chapter_2a(player_character, player_name, homescreen):
    ...
    clear_terminal_in_game(player_character, player_name)
    center_print(
        "As you walk the winding hallway you find yourself following what looks to be an old water \n"
    ...
    while True:
        ...
        if choice == "y":
            if player_character.cunning >= 6: # Cunning skill check
                ...
                center_print(
                    "As you attempt to free the object, something reaches out of the sludge and grabs your \n"
...
def chapter_2b(player_character, player_name, homescreen):
    ...
    center_print(
        "Walking down a narrow corridor you feel something whistle past your ear, catching your\n" 
...
def chapter_3a(player_character, player_name, homescreen):
    ...
    center_print(
        "You enter a large circular room. The only light source is a beam of moonlight which\n"
        "shines through a large well-like hole in the center of the ceiling, illuminating a \n"
        "single mirror in the middle of the room.\n"
    )
    
    center_print(
        "You approach the mirror to inspect it more closely, and notice that the surface of the\n"
    ...
    while True:
        ...
        if choice == "y":
            ...
            center_print(
                "As your finger comes into contact with the mirror, the surface breaks like water \n"
            ...
            if player_character.item == "None":
                ...
                center_print(
                    "When suddenly the goo loosens it's grip on you and begins to melt away, as if dissolving.\n"
                ...
                center_print(
                    f"The mass of goo constricts tightly. You hear the {player_character.item} in your \n"
            ...
            clear_terminal_in_game(player_character, player_name)
            center_print(
                "You resist the urge to touch the mirror and continue to stare at it for another\n"
...
def chapter_3b(player_character, player_name, homescreen):
    ...
    center_print(
        "Walking down the winding staircase you begin to feel uneasy. Suddenly a dark,\n"
...
def chapter_4a(player_character, player_name, homescreen):
    ...
    center_print(
        "You enter a dimly lit, long, rectangular room when the door behind you suddenly \n"
    ...
    if player_character.cunning == 9:
        center_print(
            "You dash accross the room, nimbly avoiding the jutting up peices of cobblestone\n"
            "floor. You manage to slip through the remaining gap in the door at the last\n"
            "second \n"
        )
        input()
        center_print(
            "You breath a sigh of relief for a moment, before the sudden realization hits\n"
            "you... You are now in the room with whatever brutish abomination just\n"
            "sealed the door!\n"
        )
        input()
        center_print(
            "The beast lets out a snarl and bears it's teeth. It stoops into a crouch\n"
        ...
        center_print(
            "You dash accross the room, trying to avoid the jutting up peices of cobblestone\n"
            "on the floor, but in your panic you trip and fall, foiling your chances of \n"
            "reaching the door in time.\n"
        )
        input()
        center_print(
            "As the door seals shut the room is left pitch black until suddenly the sconces\n"
            "lining the room ignite, as if by magic. There is a brief silence before you \n"
            "hear a rumbling coming from above.\n"
        )
        input()
        center_print(
            "You look upwards to see a ceiling covered in jagged metal spikes, slowly\n"
        ...
        while True:
            ...
            if choice == "m": # Might Check
                if player_character.might == 9:
                    center_input(
                        "You force your weight against the huge slab blocking you path. Years of\n"
                ...
                if player_character.wisdom == 9:
                    ...
                    center_print(
                        "You frantically search for a button or switch to help you escape but to\n"
                        "no avail.\n"
                    )
                    chapter_4a_death()
            else:
